...
export function createWorlds(refresh:()=>void){
 ...
 function makeDungeon():World{
  ...
  const monitor=group(g,5,0,-2.5);box(monitor,2,.9,.15,0,2,0,C.dark);imageScreen(monitor,'scenery-en-zo',1.85,1.04,0,2,.1);interactive(monitor,'Scenery en Zo · website','project:0');
